...
-(void)sd_SetImgWithRelativeUrlStr:(NSString *)urlStr
                placeHolderImgName:(NSString *)placeHolderImgName
{
    
    NSString *newImgUrl = JMFormat(@"%@%@",JMBASEURL,urlStr);
    [self sd_SetImgWithUrlStr:newImgUrl placeHolderImgName:placeHolderImgName];
